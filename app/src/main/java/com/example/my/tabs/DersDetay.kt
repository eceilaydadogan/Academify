...
fun DersDetailScreen(navController: NavHostController, courseName: String, viewModel: FavoriViewModel) {
    ...
    val favoriCourses = viewModel.favoriCourses.collectAsState().value
        ...
        Row(
            ...
            IconButton(
                onClick = {
                    ...
                    // Sadece tıklandığında değişmesi için isStarred değerini güncelle
                    isStarred = !isStarred
                },
                modifier = Modifier.size(48.dp)
            ) {
                val iconTint = if (isStarred) sarı else gri
                Icon(
